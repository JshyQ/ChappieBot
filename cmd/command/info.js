...
const BANNER_URL   = 'https://images8.alphacoders.com/584/thumb-1920-584430.jpg'
        ...
        await xp.sendMessage(chat.id, {
          ...
          contextInfo: {
            externalAdReply: {
              ...
              sourceUrl: 'https://whatsapp.com/channel/0029VbCWrvqJpe8nXG7Y0S0v'
            },
        ...
        for (const file of files) {
          ...
          event({
            on: obj => {
              ...
              if (name === text || cmds.includes(text)) found = obj
            }
          })
